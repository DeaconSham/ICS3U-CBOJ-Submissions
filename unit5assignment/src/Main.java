...
public class Main {
        ...
        while (true) {
            ...
            int input = Integer.parseInt(ui.nextLine());
                if (input == 1) {
                    ...
                    System.out.println("Sorry, but " + input + " is not an avaliable option.");
                    Enter();
                }
        }
    }
    public static void title() {
        ...
        System.out.println("░░╚██╔╝░╚██╔╝░╚█████╔╝██║░░██║██████╔╝███████╗███████╗");
        System.out.println("░░░╚═╝░░░╚═╝░░░╚════╝░╚═╝░░╚═╝╚═════╝░╚══════╝╚══════╝");
        System.out.println("Java Edition by Deacon Sham for Colonel By SS - ICS3U");
    }
    ...
    public static void rules() {
        ...
        System.out.println(ANSI_WHITE + "White: the inputted letter is wrong.\n" + ANSI_YELLOW + "Yellow: the inputted letter is in the wrong place.\n" + ANSI_GREEN + "Green: The inputted letter is correct." + ANSI_WHITE);
        System.out.println("\nThis project was created by Deacon Sham for the class ICS3U at Colonel By Secondary School.");
        Enter();
    }
    //methods that are utilities to help run the program
